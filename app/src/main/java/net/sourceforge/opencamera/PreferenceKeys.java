...
public class PreferenceKeys {
    ...
    public static String getPreviousBurstModePreferenceKey() {
        return "preference_burst_mode_prev";
    }

    public static String getPreviousISOPreferenceKey() {
        return "preference_iso_prev";
    }

    public static String getPreviousExposureTimePreferenceKey() {
        return "preference_exposure_time_prev";
    }

    public static String getPreviousFocusPreferenceKey() {
        return "preference_focus_prev";
    }

    public static String getPreviousFlashPreferenceKey() {
        return "preference_flash_prev";
    }
}
